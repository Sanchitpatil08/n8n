		...
		extend: {
			colors: {
				...
				dashboard: {
					...
					'surface-elevated': 'hsl(var(--dashboard-surface-elevated))'
				},
				// Email category colors
				email: {
					primary: 'hsl(var(--email-primary))',
					promotional: 'hsl(var(--email-promotional))',
					spam: 'hsl(var(--email-spam))',
					social: 'hsl(var(--email-social))',
					updates: 'hsl(var(--email-updates))',
					forums: 'hsl(var(--email-forums))'
				}
			},
			backgroundImage: {
